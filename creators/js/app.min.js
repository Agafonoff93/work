...
if(document.querySelector('.slider-events')) {
	new Swiper('.slider-events', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-arrow__next_arrows-events',
			prevEl: '.slider-arrow__prev_arrows-events',
		},
...
if(document.querySelector('.slider-business')) {
	new Swiper('.slider-business', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-arrow__next_arrows-business',
			prevEl: '.slider-arrow__prev_arrows-business',
		},
...
if(document.querySelector('.slider-holiday')) {
	new Swiper('.slider-holiday', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-arrow__next_arrows-holiday',
			prevEl: '.slider-arrow__prev_arrows-holiday',
		},
...
if(document.querySelector('.slider-party')) {
	new Swiper('.slider-party', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-arrow__next_arrows-party',
			prevEl: '.slider-arrow__prev_arrows-party',
		},
...
if(document.querySelector('.slider-features__body')) {
	new Swiper('.slider-features__body', {
...
if(document.querySelector('.slider-features__thumbs')) {
	new Swiper('.slider-features__thumbs', {
...
if(document.querySelector('.fullscreen__wrapper')) {
	new Swiper('.fullscreen__wrapper', {
...
window.onload = function() {
   ...
   //Actions (делегирования события click)
   function documentActions(e) {
      ...
      console.log(targetElement);
		...
		if (targetElement.classList.contains('header-search__btn-call')) {
			document.querySelector('.header-search__forms').classList.toggle('_active');
		} else if (!targetElement.closest('.header-search__forms') && document.querySelector('.header-search__forms._active')) {
			document.querySelector('.header-search__forms').classList.remove('_active');
		}
	}
